...
class User extends Authenticatable
{
    ...
    public function sendCode($receiverNumber,$message){
        ...
        try {
            ...
            $url = 'https://gcd.ims.co.ke/expresssms/Api/send_bulk_api?action=send-sms&api_key=Snh2SGFQT0dIZmFtcRGU9ZXBlcEQ=&to=' . $receiverNumber . '&from=IMS&sms=' . $encodMessage . '&response=json&unicode=0&bulkbalanceuser=voucher';
