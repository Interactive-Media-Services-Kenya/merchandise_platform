                                    ...
                                    <tbody>
                                        @foreach ($products as $key => $product)
                                            <tr data-entry-id="{{ $product->id }}">
                                             ...
                                             <!-- Modal -->
                                             <div class="modal fade" id="staticBackdrop{{$product->product->id}}" data-backdrop="static"
                                             data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                                             aria-hidden="true">
                                             <div class="modal-dialog">
                                                 <div class="modal-content">
                                                     <div class="modal-header">
                                                         <h5 class="modal-title" id="staticBackdropLabel">{{$product->product->product_code}}
                                                         </h5>
                                                     ...
                                                     <form action="{{ route('product.reject', [$product->product->id]) }}"
                                                        method="post">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="form-group mt-4">
                                                                <label for="reason"><h6>Select Reason</h6></label>
                                                            ...
                                                            <div class="form-group mt-4">
                                                                <label for="description"><h6>Reason Description</h6></label>
                                                                <textarea class="form-control" name="description" id=""
                                                                    cols="20" rows="5" style="border:solid 1px;"></textarea>
                                                            </div>
                                                        </div>
