                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text"
                                        class="form-control @error('title') is-invalid @enderror  input"
                                        style="border: 1px solid; border-radius:10px;" name="title"
                                        value="{{ $storage->title }}" required autocomplete="title" autofocus
