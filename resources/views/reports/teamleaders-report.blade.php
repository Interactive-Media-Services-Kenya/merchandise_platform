                        ...
                        <div class="bg-gradient-success shadow-primary border-radius-lg py-3 pe-1 text-center">
                            ...
                            <div class="col-md-5 mx-auto text-center">
                                <div class="row form-group input-daterange">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="user_id"><h4>Select Team Leader</h4></label>
                                            <select name="user_id" id="user_id" class="form-control text-center mb-4" style="border:1px solid; background:#fff;">
                                                <option selected disabled>Click To Select
                                                </option>
                                                @forelse ($teamleaders as $leader)
                                                    <option value="{{ $leader->id }}">{{ strtoupper($leader->name) }} ({{$leader->email}})
                                                    </option>
                                                @empty
